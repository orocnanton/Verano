<?php
/**
 * Template Name: Front Page option 2
 *
 *
...
<!--				<p><a class="btn" href="">Leer más</a></p>-->
	...
	<article class="hentry">
		<div class="front-page row">
			...
			<div class="third-col">
				<img
					src="http://192.168.0.15:8888/wp-verano/wp-content/uploads/2016/07/sunset-174276_1920-860x573.jpg"
					alt="triforce">
				<p>Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de
					texto</p>
			</div>
			<div class="third-col">
				<img
					src="http://192.168.0.15:8888/wp-verano/wp-content/uploads/2016/07/raspberry-1465988_1920-860x573.jpg"
					alt="triforce">
				<p>Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de
					texto</p>
